...
let rabbit="rabbit";
function findAnimal(cat,rabbit){
	let cat1="cat"}
	console.log("cat");
	console.log("rabbit");
...
function calculateYearsSinceLastOlympics(presentYear, lastOlympicsYear) {
...
const nowYear=2023;
function calculateAge(nowYear,friendYearOfBirth) {
return nowYear - friendYearOfBirth;
}
console.log (nowYear-1985);
...
const thisYear=2023;
function calculateAge(myYear){
	return thisYear - myYear;
}
console.log(thisYear - 1984)
